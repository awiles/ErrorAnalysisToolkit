...
plotCovariance4View(1000, [0 0 0]', probeIso.Actual.stats.Sigma, 'g', '-', 1)
%plotCovariance4View(N, [0 0 0]', probeIso.Meas.stats.Sigma, 'k', '--', 1)

fig6 = figure('Name', 'Tip Error Covariance: Anisotropic Error');
plotCovariance4View(1000, [0 0 0]', probeAniso.Actual.stats.Sigma, 'g', '-', 1)
...
plotCovarianceEllipse3(0.95, 1000/5, [0 0 0]', probeIso.Actual.stats.Sigma, 'y', 1);
plotCovarianceEllipse3(0.95, 1000/5, [0 0 0]', probeAniso.Actual.stats.Sigma, 'b', 1);
...
print('-deps2','-tiff','-r300', casename);
%print -dpng -r300 iso_v_aniso;
%print -djpeg -r300 iso_v_aniso;
copyfile('*.eps', 'E:\docs\research\phd\publications\journal_papers\IEEE\anisotropic_TRE_Final' );
fprintf('%s\n',subtitle);
% Principal Axes
